...
<body>
    <h2 class="my-5"> Welcome , <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>.</h2>
...
<body>
        ...
        <h4><p class="alert alert-success">Upload  And  Download Files from here ..</p></h4> 
        <br />
            <form enctype="multipart/form-data" action="" name="form" method="post">
                <h4>Select your Document</h4>
                <input type="file" name="file" id="file" class="btn"/></td>
        ...
        <a href="logout.php" class="btn btn-danger ml-3">Sign Out</a>&nbsp&nbsp
